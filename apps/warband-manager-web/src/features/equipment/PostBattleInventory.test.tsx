...
import type { CampaignAppService, CampaignDocument } from "../campaign/types";
import { CampaignAppProvider } from "../campaign/useCampaignApp";
import { PostBattleInventory } from "./PostBattleInventory";

vi.mock("../hirelings/HirelingsPanel", () => ({ HirelingsPanel: () => <p>Contenido de comercio</p> }));
vi.mock("../economy/ManualCorrectionsPanel", () => ({ ManualCorrectionsPanel: () => <p>Ajustes manuales</p> }));
