  ...
  return <section aria-label="Campaign">
    ...
    {doc.campaign.configuration.is_draft && knowledge ? <DraftWorkspace document={doc} knowledge={knowledge} locale={locale} /> : <div className="campaign-layout">
      ...
      <div className="moment-detail">
        ...
        {selected.startsWith("post:") && (selectedPost?.complete ? <PostBattleHistory document={doc} battleNumber={battleNumber} locale={locale} /> : <><BattlePanel document={doc} knowledge={knowledge} locale={locale} />{knowledge && <PostBattleInjuries document={doc} knowledge={knowledge} />}<InjuriesPanel document={doc} knowledge={knowledge} />{knowledge && <PostBattleExperience document={doc} knowledge={knowledge} />}{knowledge && <ExplorationPanel document={doc} knowledge={knowledge} locale={locale} />}{knowledge && <ScenarioFollowupsPanel document={doc} knowledge={knowledge} locale={locale} />}<FollowUpAcknowledgements document={doc} locale={locale}/>{knowledge && <WyrdstoneSalePanel document={doc} knowledge={knowledge} />}<VeteranPoolPanel document={doc} />{knowledge && <RecruitProfilePanel document={doc} knowledge={knowledge} locale={locale} />}<GroupRecruitmentPanel document={doc} locale={locale} />{knowledge && <RareSearchPanel document={doc} knowledge={knowledge} />}<HirelingsPanel document={doc} listings={knowledge} locale={locale} /><HirelingUpkeepPanel document={doc} locale={locale} /><EquipmentPanel document={doc} locale={locale} />{knowledge && <ManualSkillPanel document={doc} knowledge={knowledge} locale={locale} />}{knowledge && <ManualCorrectionsPanel document={doc} knowledge={knowledge} locale={locale} />}<ReviewPanel document={doc} locale={locale} /></>)}
      </div></div>}
  </section>;
}
