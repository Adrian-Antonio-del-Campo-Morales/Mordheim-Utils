...
import { inspectPresentationTypes } from "./presentation-type-audit.mjs";

test("KB provenance survives module boundaries and rejects unvalidated strings", () => {
  const filename = resolve("tools/presentation-type-contract.virtual.ts");
  const source = `
    import { PresentationIndex, unavailableText, type ResolvedKbText } from "../../../packages/typescript/adapters/knowledge-reader/presentation";
