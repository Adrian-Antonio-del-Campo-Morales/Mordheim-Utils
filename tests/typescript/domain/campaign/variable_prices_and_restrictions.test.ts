/**
 * Parity port of desktop `tests/python/campaign/test_variable_prices_and_restrictions.py`
 * (15 test functions → behavioural equivalents). Traceability: manifest rows
 * with `web_target: tests/typescript/domain/campaign/variable_prices_and_restrictions.test.ts`.
 *
