/**
 * Parity port of desktop `tests/python/campaign/test_post_battle_advancements.py`
 * (27 test functions → behavioural equivalents). Traceability: manifest rows
 * with `web_target: tests/typescript/domain/campaign/post_battle_advancements.test.ts`.
 *
...
import { applyAdvance, advancesForExperience } from "@domain/campaign/kernel/hirelings";
