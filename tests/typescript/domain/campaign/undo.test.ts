/**
 * Parity port of desktop `tests/python/campaign/test_undo.py` (10 test functions →
 * behavioural equivalents). Traceability: manifest rows with
 * `web_target: tests/typescript/domain/campaign/undo.test.ts`.
 *
...
import type { CampaignAppDeps, CampaignAppService } from "@app/campaign/types";
import type {
  Campaign,
  CampaignFilePort,
  KnowledgeReader,
} from "@domain/campaign/kernel/usecases";
import type { ParseResult, SerializeResult } from "@domain/campaign/kernel/ports";
