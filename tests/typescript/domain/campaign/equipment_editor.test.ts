/**
 * Parity port of desktop `tests/python/campaign/test_equipment_editor.py` (9 test
 * functions → the subset the web kernel expresses). Traceability: manifest
 * rows with `web_target: tests/typescript/domain/campaign/equipment_editor.test.ts`.
 *
