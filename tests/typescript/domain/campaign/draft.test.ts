/**
 * Parity port of desktop `tests/python/campaign/test_draft.py` (10 test functions →
 * behavioural equivalents). Traceability: manifest rows with
 * `web_target: tests/typescript/domain/campaign/draft.test.ts`.
 *
...
import { draftIsLegal, memberCount, treasury } from "@domain/campaign/kernel/document";
