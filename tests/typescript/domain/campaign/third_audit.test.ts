/**
 * Parity port of desktop `tests/python/campaign/test_third_audit_regressions.py`
 * (11 test rows → behavioural equivalents). Traceability: manifest rows with
 * `web_target: tests/typescript/domain/campaign/third_audit.test.ts`.
 *
...
import { applyAdvance } from "@domain/campaign/kernel/hirelings";
import type { CampaignDocument, Warrior } from "@domain/campaign/kernel/usecases";
