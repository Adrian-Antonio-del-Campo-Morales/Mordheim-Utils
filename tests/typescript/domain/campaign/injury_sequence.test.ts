/**
 * Parity port of desktop `tests/python/campaign/test_injury_sequence_matrix.py`.
...
import { resolvePrisoner } from "@app/campaign/features/injuries/injury-decisions-workflow";
import { injuryEffects, resolveInjuryTableFollowUp } from "@app/campaign/features/injuries/injury-followup-workflow";
import { applyInjuryOutcome } from "@app/campaign/features/injuries/injuries-workflow";
import { resolveSoldToPits } from "@app/campaign/features/injuries/sold-to-pits-workflow";
import type { KnowledgeReader } from "@domain/campaign/kernel/ports";
import type { CampaignDocument, OpenPayload } from "@domain/campaign/kernel/state";
