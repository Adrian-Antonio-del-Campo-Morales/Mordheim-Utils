/**
 * Parity port of desktop `tests/python/campaign/test_out_of_action_tracking.py`
 * (7 test functions → behavioural equivalents). Traceability: manifest rows
 * with `web_target: tests/typescript/domain/campaign/out_of_action_tracking.test.ts`.
 *
...
import type { CampaignFilePort, KnowledgeReader } from "@domain/campaign/kernel/ports";
