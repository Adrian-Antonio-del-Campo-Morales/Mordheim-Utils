/**
 * Parity port of desktop `tests/python/campaign/test_extended_audit_regressions.py`
 ...
 * with `web_target: tests/typescript/domain/campaign/extended_audit.test.ts`.
 *
