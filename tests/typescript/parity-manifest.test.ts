 ...
 * The Python gate (tests/python/web/parity/python_manifest_test.py)
...
const MANIFEST = resolve(ROOT, "outputs/parity/test-manifests/campaign-test-manifest.json");
execFileSync("python", [resolve(ROOT, "tools/verification/make_test_manifest.py")], { cwd: ROOT, stdio: "pipe" });
