...
import { inspectPresentation, inspectCssPresentation, guiReport, audit } from "../../../tools/web/presentation-audit.mjs";
...
test("real GUI deep analysis blocks every unresolved text-provenance path", () => {
  // The tool lives in tools/web; the audited surface is the web application.
  const root = fileURLToPath(new URL("../../../apps/warband-manager-web/", import.meta.url));
