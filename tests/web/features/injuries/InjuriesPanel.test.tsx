import { translate, type UiText } from "@src/features/campaign/i18n-core";
/**
...
import { InjuriesPanel } from "@src/features/injuries/InjuriesPanel";
import { useCampaignApp } from "@src/features/campaign/useCampaignApp";

vi.mock("@src/features/campaign/useCampaignApp", () => ({
