...
ARTEFACT = REPO_ROOT / "outputs" / "campaign-file-interop" / "_ts-roundtrip-artefact.json"
WORKFLOW_ARTEFACT = REPO_ROOT / "outputs" / "campaign-file-interop" / "_p71-workflow-documents.json"
