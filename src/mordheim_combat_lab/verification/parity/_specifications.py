"""Semantic-specification driven parity: vectorized adapters per
case operation plus the specification inventory verifier."""
...
from mordheim_combat_lab.verification.parity._report import SpecificationParityCase, SpecificationParityReport
