...
STRINGS.update({k: {"es": v} for k, v in {
    ...
    '{} configurations exceed the {} safety limit. Reduce maximum changed slots.': '{} configuraciones superan el límite de seguridad de {}. Reduce el máximo de ranuras modificadas.',
