/**
 * Parity port of desktop `tests/campaign/test_post_battle_resolution.py`
 * (9 test functions → behavioural equivalents). Traceability: manifest rows
 * with `web_target: packages/typescript/domain/campaign/post_battle_resolution.test.ts`.
 *
