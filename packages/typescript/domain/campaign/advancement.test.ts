/**
 * Parity port of desktop `tests/campaign/test_advancement_sequence_matrix.py`
 * (76 rows → behavioural equivalents). Traceability: manifest rows with
 * `web_target: packages/typescript/domain/campaign/advancement.test.ts`.
 *
