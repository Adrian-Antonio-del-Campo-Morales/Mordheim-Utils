/**
 * Parity port of desktop `tests/campaign/test_hire_eligibility.py` (15 test
 * functions → behavioural equivalents). Traceability: manifest rows with
 * `web_target: packages/typescript/domain/campaign/hire_eligibility.test.ts`.
 *
