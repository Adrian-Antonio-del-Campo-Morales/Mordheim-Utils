/**
 * Parity port of desktop `tests/campaign/test_battle_creation.py` (19 test
 ...
 * with `web_target: packages/typescript/domain/campaign/battle_creation.test.ts`.
 *
...
import { createBattleWorkflow } from "../../application/campaign/features/battle/battle-workflow";
