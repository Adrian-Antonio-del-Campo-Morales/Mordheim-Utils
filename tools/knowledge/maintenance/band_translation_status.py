...
Usage::
    ...
    python tools/knowledge/maintenance/band_translation_status.py            # summary table
    python tools/knowledge/maintenance/band_translation_status.py --json     # machine-readable
    python tools/knowledge/maintenance/band_translation_status.py --band X   # detail for one band
...
BANDS_ROOT = Path(__file__).resolve().parents[3] / "sources" / "knowledge" / "bands"
