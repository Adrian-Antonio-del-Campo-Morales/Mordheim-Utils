...
Usage
-----
    python tools/knowledge/maintenance/price-collation.py [--outdir outputs/knowledge]
"""
...
def write_markdown(rows: list[dict], target: Path) -> None:
    ...
    lines = [
        ...
        "",
        f"_Regenerate with `python tools/knowledge/maintenance/price-collation.py`._  ",
